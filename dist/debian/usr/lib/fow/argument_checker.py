...
def check_rules(cmd_list, rules):
    ...
    args = normalize_commands(cmd_list, atom_list)
    # print('check_rules() args={}'.format(args))

    ret = analyze_rules(args, rules)
...
def analyze_rules(args, rules):
    ...
    # print("analyze_rules() Check rule by rule against the actuals")
    for rule in rules:
        ...
        # print("analyze_rules()   2. Check all args against rule items")
...
def _analyze_params(args, rule):
    ...
    if ret['valid_options']:
        # print("analyze_rules()  valid options")
        ...
        # print("analyze_rules() expected_none_arg={}".format(str(expected_none_arg)))
...
def _options_match_rule(items, rule, _type):
    """
    ...
    # print('_options_match_rule() _type=' + _type)
...
def normalize_commands(_actual, atoms):
    """
